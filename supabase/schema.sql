...
CREATE OR REPLACE FUNCTION "public"."assert_savings_calculation_baseline_quality"("p_event_id" "uuid", "p_calculation" "jsonb") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_catalog', 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."assert_savings_calculation_baseline_quality"("p_event_id" "uuid", "p_calculation" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."assert_savings_schedule_baseline_quality"("p_savings_calculation_id" "uuid", "p_periods" "jsonb", "p_use_selected_baseline" boolean) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_catalog', 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."assert_savings_schedule_baseline_quality"("p_savings_calculation_id" "uuid", "p_periods" "jsonb", "p_use_selected_baseline" boolean) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."save_estimated_savings_calculation_unchecked"("p_event_id" "uuid", "p_calculation" "jsonb", "p_calculation_id" "uuid" DEFAULT NULL::"uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'pg_catalog', 'public'
    AS $$
declare
...
ALTER FUNCTION "public"."save_estimated_savings_calculation_unchecked"("p_event_id" "uuid", "p_calculation" "jsonb", "p_calculation_id" "uuid") OWNER TO "postgres";
...
REVOKE ALL ON FUNCTION "public"."assert_savings_calculation_baseline_quality"("p_event_id" "uuid", "p_calculation" "jsonb") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."assert_savings_calculation_baseline_quality"("p_event_id" "uuid", "p_calculation" "jsonb") TO "service_role";



REVOKE ALL ON FUNCTION "public"."assert_savings_schedule_baseline_quality"("p_savings_calculation_id" "uuid", "p_periods" "jsonb", "p_use_selected_baseline" boolean) FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."assert_savings_schedule_baseline_quality"("p_savings_calculation_id" "uuid", "p_periods" "jsonb", "p_use_selected_baseline" boolean) TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."save_estimated_savings_calculation_unchecked"("p_event_id" "uuid", "p_calculation" "jsonb", "p_calculation_id" "uuid") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."save_estimated_savings_calculation_unchecked"("p_event_id" "uuid", "p_calculation" "jsonb", "p_calculation_id" "uuid") TO "service_role";
