...
- Lets administrators govern Support projects and the optional project
  description, owner, and Cost Center fields without removing historical data.
...
2. Complete workspace governance with membership administration, audit
   visibility, and workspace-managed selection lists.
